...
public class DoubleLinkedList implements List {
    ...
    public void insertAfter(Node key, Node input) {
        ...
        boolean found = false;
        while (temp != null) {
            if (temp.data == key.data && temp == head) {
                this.addFirst(input);
                found = true;
                System.out.println("Data " + input.data + " berhasil ditambahkan setelah data " + key.data);
                break;
                ...
                temp.kanan = input;
                found = true;
                System.out.println("Data " + input.data + " berhasil ditanbahkan setelah data " + key.data);
                break;
            }
            temp = temp.kanan;
        }
        if (!found)
            System.out.println("Data " + key.data + " gagal ditanbahkan");
    }
    ...
    public void insertBefore(Node key, Node input) {
        ...
        boolean found = false;
        while (temp != null){
            if (temp.data == key.data && temp == tail) {
                this.addLast(input);
                found = true;
                System.out.println("Data " + input.data + " berhasil ditambahkan setelah data " + key.data);
                break;
